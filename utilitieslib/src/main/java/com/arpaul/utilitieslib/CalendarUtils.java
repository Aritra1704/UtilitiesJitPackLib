...
public class CalendarUtils {
    ...
    public static String getCurrentDateTime() {
        ...
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(DATE_TIME_FORMAT_T);
        reqDate = simpleDateFormat.format(calendar.getTime());
    ...
    public static int getDiffBtwDatesInMinutes(String startDate,String endDate)
    {
        ...
        calendar1.setTime(CalendarUtils.getDateFromString(startDate, CalendarUtils.DATE_TIME_FORMAT_T));
        calendar2.setTime(CalendarUtils.getDateFromString(endDate, CalendarUtils.DATE_TIME_FORMAT_T));
